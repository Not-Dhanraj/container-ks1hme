...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ks1hme.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ks1hme.containers.anotherwebservice.com/
...
```
git clone git@github.com:Not-Dhanraj/container-ks1hme.git
cd container-ks1hme
```
...
```
docker attach container-ks1hme
```
